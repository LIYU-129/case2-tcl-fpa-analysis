...
### 4. 改善决策：将毛利改善转化为可量化的项目判断

光伏业务在 2025 年保持较快收入增长，但毛利率由约 **9.6%** 降至 **8.6%**，体现出“规模增长快于利润增长”的问题。因此，本项目进一步构建毛利恢复情景，将经营问题转化为可量化的项目决策。

以 2024→2025 约 **1.01 p.p.** 的毛利率缺口作为可观察的恢复空间，并设置三种管理情景：

| 情景 | 毛利率恢复 / 成本率改善 | 年度增量毛利 | Dashboard收益投入比 | 回收期 |
|---|---:|---:|---:|---:|
| 保守 | 约 0.40 p.p. | 约 HK$84.8m | **80.5%** | **14.9个月** |
| 基准 | 约 0.70 p.p. | 约 HK$148.4m | **140.9%** | **8.5个月** |
| 乐观 | 约 1.01 p.p. | 约 HK$212.0m | **201.3%** | **6.0个月** |

项目投入设为 2025 光伏收入的 **0.5%（约 HK$105m）**，作为管理分析情景而非公司披露值。由此可进一步得到：

> 若希望项目在 **12个月内回收投入**，成本率至少需要改善约 **0.50 p.p.**。

这一分析将“建议降本增效”进一步转化为可量化的收益、投入和决策门槛，用于模拟 FP&A / 财务BP 的经营决策支持过程。

> **口径说明：** Dashboard 中“ROI”采用年度增量毛利 ÷ 项目投入的收益投入比口径，用于情景对比；若采用净 ROI =（收益－投入）÷投入，则基准情景约为 40.9%。

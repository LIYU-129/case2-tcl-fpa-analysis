...
### 4. 改善决策：将“降本增效”转化为可量化的投资门槛

选择光伏业务作为经营改善案例，构建毛利恢复情景。
...
> 若希望项目在 **12个月内回收投资**，成本率至少需要改善约 **0.50 p.p.**。

这一门槛可用于支持项目的 Go / No-Go 判断，而不是停留在“加强成本控制”的泛化建议。
...
| 改善决策 | 改善项目值不值得做？ | ROI、Payback、Breakeven |
